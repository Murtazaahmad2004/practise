<?php
   ...
   if (isset($_POST["submit"])) 
   {
       ...
       $sql = "INSERT INTO teacher (`Teacher ID`, `Teacher Name`, `Question 1`, `Question 2`, `Question 3`, `Question 4`) 
               VALUES ('$tid', '$tn', '$q1', '$q2', '$q3', '$q4')";
            ...
            <form method="POST" action="">
               <table class="table profile_table" border="5" align="center">
                  <tbody>
                     <tr>
                        <td>
                           <input type="text" name="teacher_name" value="Engr. Wasif Khan" readonly/>
                        </td>
                     </tr>
                     <tr>
