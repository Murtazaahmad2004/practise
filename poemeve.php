            ...
            <form method="POST" action="">
               <table class="table profile_table" border="5" align="center">
                  <tbody>
                     <tr>
                        <td>
                           <input type="text" name="course_name" value="Principle Of Eco And Mang" readonly/>
                           <input type="text" name="course_id" value="8935" readonly/>
                        </td>
                     </tr>
                     <tr>
