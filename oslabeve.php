...
<html lang="en">
   <head>
      ...
      <title>Operating System(Lab) Evaluation</title>
      <style>
         .profile_table{
         width: auto;
         margin-left: 250px;
            ...
            <form method="POST" action="">
               <table class="table profile_table" border="5" align="center">
                  <tbody>
                     <tr>
                        <td>
                           <input type="text" name="course_name" value="Operating System (Lab)" readonly/>
                           <input type="text" name="course_id" value="11327" readonly/>
                        </td>
                     </tr>
                     <tr>
